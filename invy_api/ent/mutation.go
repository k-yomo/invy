...
const (
	...
	TypeInvitationAwaiting    = "InvitationAwaiting"
...
// InvitationAwaitingMutation represents an operation that mutates the InvitationAwaiting nodes in the graph.
type InvitationAwaitingMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	...
	oldValue      func(context.Context) (*InvitationAwaiting, error)
	predicates    []predicate.InvitationAwaiting
}

var _ ent.Mutation = (*InvitationAwaitingMutation)(nil)

// invitationawaitingOption allows management of the mutation configuration using functional options.
type invitationawaitingOption func(*InvitationAwaitingMutation)

// newInvitationAwaitingMutation creates new mutation for the InvitationAwaiting entity.
func newInvitationAwaitingMutation(c config, op Op, opts ...invitationawaitingOption) *InvitationAwaitingMutation {
	m := &InvitationAwaitingMutation{
		config:        c,
		op:            op,
		typ:           TypeInvitationAwaiting,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withInvitationAwaitingID sets the ID field of the mutation.
func withInvitationAwaitingID(id uuid.UUID) invitationawaitingOption {
	return func(m *InvitationAwaitingMutation) {
		var (
			err   error
			once  sync.Once
			value *InvitationAwaiting
		)
		m.oldValue = func(ctx context.Context) (*InvitationAwaiting, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().InvitationAwaiting.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withInvitationAwaiting sets the old InvitationAwaiting of the mutation.
func withInvitationAwaiting(node *InvitationAwaiting) invitationawaitingOption {
	return func(m *InvitationAwaitingMutation) {
		m.oldValue = func(context.Context) (*InvitationAwaiting, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m InvitationAwaitingMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m InvitationAwaitingMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of InvitationAwaiting entities.
func (m *InvitationAwaitingMutation) SetID(id uuid.UUID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *InvitationAwaitingMutation) ID() (id uuid.UUID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *InvitationAwaitingMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().InvitationAwaiting.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetUserID sets the "user_id" field.
func (m *InvitationAwaitingMutation) SetUserID(u uuid.UUID) {
	m.user = &u
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *InvitationAwaitingMutation) UserID() (r uuid.UUID, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// OldUserID returns the old "user_id" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldUserID(ctx context.Context) (v uuid.UUID, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUserID resets all changes to the "user_id" field.
func (m *InvitationAwaitingMutation) ResetUserID() {
	m.user = nil
}

// SetStartsAt sets the "starts_at" field.
func (m *InvitationAwaitingMutation) SetStartsAt(t time.Time) {
	m.starts_at = &t
}

// StartsAt returns the value of the "starts_at" field in the mutation.
func (m *InvitationAwaitingMutation) StartsAt() (r time.Time, exists bool) {
	v := m.starts_at
	if v == nil {
		return
	}
...
// OldStartsAt returns the old "starts_at" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldStartsAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStartsAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStartsAt resets all changes to the "starts_at" field.
func (m *InvitationAwaitingMutation) ResetStartsAt() {
	m.starts_at = nil
}

// SetEndsAt sets the "ends_at" field.
func (m *InvitationAwaitingMutation) SetEndsAt(t time.Time) {
	m.ends_at = &t
}

// EndsAt returns the value of the "ends_at" field in the mutation.
func (m *InvitationAwaitingMutation) EndsAt() (r time.Time, exists bool) {
	v := m.ends_at
	if v == nil {
		return
	}
...
// OldEndsAt returns the old "ends_at" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldEndsAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *InvitationAwaitingMutation) ResetEndsAt() {
	m.ends_at = nil
}

// SetComment sets the "comment" field.
func (m *InvitationAwaitingMutation) SetComment(s string) {
	m.comment = &s
}

// Comment returns the value of the "comment" field in the mutation.
func (m *InvitationAwaitingMutation) Comment() (r string, exists bool) {
	v := m.comment
	if v == nil {
		return
	}
...
// OldComment returns the old "comment" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldComment(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldComment is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetComment resets all changes to the "comment" field.
func (m *InvitationAwaitingMutation) ResetComment() {
	m.comment = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *InvitationAwaitingMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *InvitationAwaitingMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *InvitationAwaitingMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *InvitationAwaitingMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *InvitationAwaitingMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the InvitationAwaiting entity.
// If the InvitationAwaiting object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *InvitationAwaitingMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *InvitationAwaitingMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// ClearUser clears the "user" edge to the User entity.
func (m *InvitationAwaitingMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared reports if the "user" edge to the User entity was cleared.
func (m *InvitationAwaitingMutation) UserCleared() bool {
	return m.cleareduser
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UserID instead. It exists only for internal usage by the builders.
func (m *InvitationAwaitingMutation) UserIDs() (ids []uuid.UUID) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUser resets all changes to the "user" edge.
func (m *InvitationAwaitingMutation) ResetUser() {
	m.user = nil
	m.cleareduser = false
}

// Where appends a list predicates to the InvitationAwaitingMutation builder.
func (m *InvitationAwaitingMutation) Where(ps ...predicate.InvitationAwaiting) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the InvitationAwaitingMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *InvitationAwaitingMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.InvitationAwaiting, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *InvitationAwaitingMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *InvitationAwaitingMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (InvitationAwaiting).
func (m *InvitationAwaitingMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *InvitationAwaitingMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.user != nil {
		fields = append(fields, invitationawaiting.FieldUserID)
	}
	if m.starts_at != nil {
		fields = append(fields, invitationawaiting.FieldStartsAt)
	}
	if m.ends_at != nil {
		fields = append(fields, invitationawaiting.FieldEndsAt)
	}
	if m.comment != nil {
		fields = append(fields, invitationawaiting.FieldComment)
	}
	if m.created_at != nil {
		fields = append(fields, invitationawaiting.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, invitationawaiting.FieldUpdatedAt)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *InvitationAwaitingMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *InvitationAwaitingMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case invitationawaiting.FieldUserID:
		return m.OldUserID(ctx)
	case invitationawaiting.FieldStartsAt:
	...
	return nil, fmt.Errorf("unknown InvitationAwaiting field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *InvitationAwaitingMutation) SetField(name string, value ent.Value) error {
	switch name {
	case invitationawaiting.FieldUserID:
		v, ok := value.(uuid.UUID)
		if !ok {
	...
	return fmt.Errorf("unknown InvitationAwaiting field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *InvitationAwaitingMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *InvitationAwaitingMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *InvitationAwaitingMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown InvitationAwaiting numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *InvitationAwaitingMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *InvitationAwaitingMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *InvitationAwaitingMutation) ClearField(name string) error {
	return fmt.Errorf("unknown InvitationAwaiting nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *InvitationAwaitingMutation) ResetField(name string) error {
	switch name {
	case invitationawaiting.FieldUserID:
		m.ResetUserID()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *InvitationAwaitingMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.user != nil {
		edges = append(edges, invitationawaiting.EdgeUser)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *InvitationAwaitingMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case invitationawaiting.EdgeUser:
		if id := m.user; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *InvitationAwaitingMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *InvitationAwaitingMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *InvitationAwaitingMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.cleareduser {
		edges = append(edges, invitationawaiting.EdgeUser)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *InvitationAwaitingMutation) EdgeCleared(name string) bool {
	switch name {
	case invitationawaiting.EdgeUser:
		return m.cleareduser
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *InvitationAwaitingMutation) ClearEdge(name string) error {
	switch name {
	case invitationawaiting.EdgeUser:
		m.ClearUser()
		return nil
	}
	return fmt.Errorf("unknown InvitationAwaiting unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *InvitationAwaitingMutation) ResetEdge(name string) error {
	switch name {
	case invitationawaiting.EdgeUser:
		m.ResetUser()
		return nil
	}
	return fmt.Errorf("unknown InvitationAwaiting edge %s", name)
}
