...
// The LineAuthFunc type is an adapter to allow the use of ordinary
// function as LineAuth mutator.
type LineAuthFunc func(context.Context, *ent.LineAuthMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f LineAuthFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.LineAuthMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.LineAuthMutation", m)
	}
	return f(ctx, mv)
}
