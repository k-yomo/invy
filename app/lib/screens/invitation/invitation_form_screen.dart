...
class InvitationFormRoute extends GoRouteData {
...
class InvitationFormScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final invitationScreenViewerQuery = useMemoized(() =>
        graphqlClient.watchQuery$invitationFormScreenViewer(
    ...
    final selectedFriendGroups =
        ref.watch(invitationFormProvider).selectedFriendGroups;
    final selectedFriends = ref.watch(invitationFormProvider).selectedFriends;
    ...
    onSubmittedForm({
      ...
      final targetFriendGroupIds = (isTargetSelected
          ...
          .map((fg) => fg.id)
          .toList();
      final targetFriendUserIds = (isTargetSelected
              ? selectedFriends
...
class InvitationDetailFormState extends ConsumerState<InvitationDetailForm> {
  ...
  Widget build(BuildContext context) {
    final invitationForm = ref.watch(invitationFormProvider);
    ...
    useEffect(() {
      locationController.text = invitationForm.locationName;
      return null;
    }, []);
